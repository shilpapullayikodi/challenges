...
const firstAnimalStartingWithLetterG = animals.find((animal) =>
  animal.name.toUpperCase().startsWith("G")
);
...
const animalsSortedByWeightStartingWithLowest = animals
  .slice()
  .sort((weightA, weightB) => weightA.weight - weightB.weight);
...
console.log("Sorted reverse", animalsSortedByWeightReversed);
...
const weightOfAllAnimalsInAfrica = animals
  ...
  .reduce((weight, animal) => weight + animal);
